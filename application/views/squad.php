            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <p class="navbar-brand">Visão dos times</p>
                    </div>
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <a href="<?= base_url('partial'); ?>">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="header">
                                    <h3 class="title">Dexolas Dexolas </h3>
                                    <p class="category">Vinicius</p>
                                    <h4 class="title">88.25 pts</h4>
                                </div>
                                <div class="content">
                                    <div class="content table-responsive table-full-width">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>MEI</td>
                                                    <td><i class="ti-star" title="Capitão"></i></td>
                                                    <td>Rodriguinho</td>
                                                    <td>11.00 pts</td>
                                                </tr>
                                                <tr>
